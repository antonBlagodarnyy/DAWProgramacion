...
public class PedidoServlet extends HttpServlet {
	...
	private Pedido crearPedido(int idProducto, Cliente usuario) {
		DAOProducto listaProductos=new DAOProducto();
		Producto producto=(Producto) listaProductos.getProducto(idProducto);
		Pedido pedido= new Pedido (producto,usuario,LocalDate.now());
		return pedido;
